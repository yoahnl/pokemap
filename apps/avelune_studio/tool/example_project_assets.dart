...
List<int> exampleAtlasPng() {
  ...
  rect(142, 2, 5, 8, 224, 185, 143);
  rect(141, 0, 7, 4, 66, 49, 70);
  rect(139, 10, 12, 13, 71, 119, 175);
  rect(143, 10, 4, 13, 103, 158, 207);
  rect(140, 23, 4, 8, 54, 60, 90);
  rect(146, 23, 4, 8, 54, 60, 90);
