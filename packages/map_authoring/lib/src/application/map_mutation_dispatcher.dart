...
final class MapMutationDispatcher {
  ...
  factory MapMutationDispatcher.canonical({
    ...
    const tilesetLibrary = TilesetLibraryActions();
    ...
    const pokemonRuleset = PokemonRulesetActions();
    ...
    return MapMutationDispatcher([
      ...
      for (final descriptor in TilesetLibraryActions.descriptors)
        MapMutationActionRegistration(
          descriptor: descriptor,
      ...
      for (final descriptor in PokemonMediaImportActions.descriptors)
        MapMutationActionRegistration(
          descriptor: descriptor,
          build: PokemonMediaImportActions(artifactStore: artifacts).build,
        ),
      ...
      for (final descriptor in PokemonRulesetActions.descriptors)
        MapMutationActionRegistration(
          descriptor: descriptor,
          build: pokemonRuleset.build,
        ),
      ...
      for (final descriptor
          in CharacterStudioAnimationDefinitionActions.descriptors)
        MapMutationActionRegistration(
          descriptor: descriptor,
      ...
      for (final descriptor in CharacterStudioCharacterActions.descriptors)
        MapMutationActionRegistration(
          descriptor: descriptor,
          build: characterStudioCharacters.build,
        ),
      for (final descriptor in CharacterStudioPortraitStateActions.descriptors)
        MapMutationActionRegistration(
          descriptor: descriptor,
          build: characterStudioPortraitStates.build,
        ),
