...
abstract class ProjectMenuLabelsProfile with _$ProjectMenuLabelsProfile {
  ...
  const factory ProjectMenuLabelsProfile({
    ...
    @JsonKey(includeIfNull: false) String? quests,
    @JsonKey(includeIfNull: false) String? profile,
...
ProjectPausePresentationProfile? projectPausePresentationFromMenuLabels(
  ...
  final actionLabels = <ProjectPauseActionId, String?>{
    ...
    ProjectPauseActionId.quests: labels.quests,
    ProjectPauseActionId.profile: labels.profile,
