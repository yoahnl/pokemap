...
///   sa chaîne `explicite > contextuel > fallback`.
 String? get battleBackgroundRelativePath;/// Sprite de combat du dresseur — BETA-BAT-017.
///
...
/// absent ou illisible.
@JsonKey(includeIfNull: false) String? get battleSpriteRelativePath;/// Transition de début de combat de ce dresseur — BETA-BAT-019.
///
/// Un id du registre moteur ; gagne sur la zone et le défaut projet.
/// Absent ou inconnu = la chaîne continue (zone > projet > moteur).
@JsonKey(includeIfNull: false) String? get battleTransitionId; String? get characterId; String? get portraitElementId;/// Musiques du combat contre ce dresseur — BETA-BAT-015.
///
...
/// mentaient (politique pré-1.0.0 : pas de pont de compatibilité).
 String? get battleMusicPath; String? get victoryMusicPath;/// Récompenses auteur neutres par défaut pour préserver les projets
...
/// Create a copy of ProjectTrainerEntry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? trainerClass = null,Object? battleDifficulty = freezed,Object? battleBackgroundRelativePath = freezed,Object? battleSpriteRelativePath = freezed,Object? battleTransitionId = freezed,Object? characterId = freezed,Object? portraitElementId = freezed,Object? battleMusicPath = freezed,Object? victoryMusicPath = freezed,Object? moneyReward = null,Object? rewardItemGrants = null,Object? rewardFlagIds = null,Object? rewardBadgeId = freezed,Object? rewardFieldAbilityUnlock = freezed,Object? templateKind = freezed,Object? rematchPolicy = freezed,Object? preBattleDialogueId = freezed,Object? victoryDialogueId = freezed,Object? defeatDialogueId = freezed,Object? team = null,Object? tags = null,}) {
  return _then(_self.copyWith(
...
as String?,battleSpriteRelativePath: freezed == battleSpriteRelativePath ? _self.battleSpriteRelativePath : battleSpriteRelativePath // ignore: cast_nullable_to_non_nullable
as String?,battleTransitionId: freezed == battleTransitionId ? _self.battleTransitionId : battleTransitionId // ignore: cast_nullable_to_non_nullable
...
as String?,victoryMusicPath: freezed == victoryMusicPath ? _self.victoryMusicPath : victoryMusicPath // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _ProjectTrainerEntry() when $default != null:
return $default(_that.id,_that.name,_that.trainerClass,_that.battleDifficulty,_that.battleBackgroundRelativePath,_that.battleSpriteRelativePath,_that.battleTransitionId,_that.characterId,_that.portraitElementId,_that.battleMusicPath,_that.victoryMusicPath,_that.moneyReward,_that.rewardItemGrants,_that.rewardFlagIds,_that.rewardBadgeId,_that.rewardFieldAbilityUnlock,_that.templateKind,_that.rematchPolicy,_that.preBattleDialogueId,_that.victoryDialogueId,_that.defeatDialogueId,_that.team,_that.tags);case _:
  return orElse();
...
/// et le runtime retombe honnêtement sur le message seul quand il est
/// absent ou illisible.
@override@JsonKey(includeIfNull: false) final  String? battleSpriteRelativePath;
/// Transition de début de combat de ce dresseur — BETA-BAT-019.
///
/// Un id du registre moteur ; gagne sur la zone et le défaut projet.
/// Absent ou inconnu = la chaîne continue (zone > projet > moteur).
@override@JsonKey(includeIfNull: false) final  String? battleTransitionId;
...
@override final  String? victoryMusicPath;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,trainerClass,battleDifficulty,battleBackgroundRelativePath,battleSpriteRelativePath,battleTransitionId,characterId,portraitElementId,battleMusicPath,victoryMusicPath,moneyReward,const DeepCollectionEquality().hash(_rewardItemGrants),const DeepCollectionEquality().hash(_rewardFlagIds),rewardBadgeId,rewardFieldAbilityUnlock,templateKind,rematchPolicy,preBattleDialogueId,victoryDialogueId,defeatDialogueId,const DeepCollectionEquality().hash(_team),const DeepCollectionEquality().hash(_tags)]);
...
/// Create a copy of ProjectTrainerEntry
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? trainerClass = null,Object? battleDifficulty = freezed,Object? battleBackgroundRelativePath = freezed,Object? battleSpriteRelativePath = freezed,Object? battleTransitionId = freezed,Object? characterId = freezed,Object? portraitElementId = freezed,Object? battleMusicPath = freezed,Object? victoryMusicPath = freezed,Object? moneyReward = null,Object? rewardItemGrants = null,Object? rewardFlagIds = null,Object? rewardBadgeId = freezed,Object? rewardFieldAbilityUnlock = freezed,Object? templateKind = freezed,Object? rematchPolicy = freezed,Object? preBattleDialogueId = freezed,Object? victoryDialogueId = freezed,Object? defeatDialogueId = freezed,Object? team = null,Object? tags = null,}) {
