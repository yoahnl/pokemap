...
/// absent ou illisible.
@JsonKey(includeIfNull: false) String? get battleSpriteRelativePath; String? get characterId; String? get portraitElementId;/// Musiques du combat contre ce dresseur — BETA-BAT-015.
///
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,trainerClass,battleDifficulty,battleBackgroundRelativePath,battleSpriteRelativePath,characterId,portraitElementId,battleMusicPath,victoryMusicPath,moneyReward,const DeepCollectionEquality().hash(rewardItemGrants),const DeepCollectionEquality().hash(rewardFlagIds),rewardBadgeId,rewardFieldAbilityUnlock,templateKind,rematchPolicy,preBattleDialogueId,victoryDialogueId,defeatDialogueId,const DeepCollectionEquality().hash(team),const DeepCollectionEquality().hash(tags)]);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,trainerClass,battleDifficulty,battleBackgroundRelativePath,battleSpriteRelativePath,characterId,portraitElementId,battleMusicPath,victoryMusicPath,moneyReward,const DeepCollectionEquality().hash(_rewardItemGrants),const DeepCollectionEquality().hash(_rewardFlagIds),rewardBadgeId,rewardFieldAbilityUnlock,templateKind,rematchPolicy,preBattleDialogueId,victoryDialogueId,defeatDialogueId,const DeepCollectionEquality().hash(_team),const DeepCollectionEquality().hash(_tags)]);
