...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,name,version,const DeepCollectionEquality().hash(_maps),const DeepCollectionEquality().hash(_groups),const DeepCollectionEquality().hash(_tilesetFolders),const DeepCollectionEquality().hash(_tilesets),const DeepCollectionEquality().hash(_elementCategories),const DeepCollectionEquality().hash(_elements),const DeepCollectionEquality().hash(_environmentPresets),const DeepCollectionEquality().hash(_encounterTables),const DeepCollectionEquality().hash(_dialogueFolders),const DeepCollectionEquality().hash(_dialogues),const DeepCollectionEquality().hash(_scripts),const DeepCollectionEquality().hash(_scenarios),const DeepCollectionEquality().hash(_cinematics),cinematicLibraryCatalog,const DeepCollectionEquality().hash(_presentationCinematics),const DeepCollectionEquality().hash(_cinematicMediaAssets),const DeepCollectionEquality().hash(_facts),const DeepCollectionEquality().hash(_worldRules),const DeepCollectionEquality().hash(_narrativeDiagnosticSuppressions),eventRegistry,const DeepCollectionEquality().hash(_scenes),const DeepCollectionEquality().hash(_storylines),const DeepCollectionEquality().hash(_shops),const DeepCollectionEquality().hash(_badges),const DeepCollectionEquality().hash(_trainers),const DeepCollectionEquality().hash(_characters),characterStudioCatalog,settings,pokemon,newGame,presentation,const DeepCollectionEquality().hash(_presentationPresets),const DeepCollectionEquality().hash(_globalProperties),smartTileCatalog,borderCatalog,shadowCatalog,projectedBuildingShadowCatalog]);
