...
_$ShopStateDefinitionImpl _$$ShopStateDefinitionImplFromJson(
        Map<String, dynamic> json) =>
    _$ShopStateDefinitionImpl(
      ...
      activation:
          ScriptCondition.fromJson(json['activation'] as Map<String, dynamic>),
...
Map<String, dynamic> _$$ShopStateDefinitionImplToJson(
        _$ShopStateDefinitionImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
