...
_PokemonMoveSourceRefs _$PokemonMoveSourceRefsFromJson(
  Map<String, dynamic> json,
) => _PokemonMoveSourceRefs(
  showdownMoveId: json['showdownMoveId'] as String?,
  showdownHooksPresent:
      (json['showdownHooksPresent'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const <String>[],
);

Map<String, dynamic> _$PokemonMoveSourceRefsToJson(
  _PokemonMoveSourceRefs instance,
) => <String, dynamic>{
...
_PokemonMove _$PokemonMoveFromJson(Map<String, dynamic> json) => _PokemonMove(
  ...
  target:
      $enumDecodeNullable(_$PokemonMoveTargetEnumMap, json['target']) ??
  ...
  effects:
      (json['effects'] as List<dynamic>?)
          ?.map((e) => PokemonMoveEffect.fromJson(e as Map<String, dynamic>))
          .toList() ??
  ...
  unsupportedReasons:
      (json['unsupportedReasons'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const <String>[],
