...
_ElementCollisionPixelMask _$ElementCollisionPixelMaskFromJson(
  ...
  encoding:
      $enumDecodeNullable(
        _$ElementCollisionMaskEncodingEnumMap,
        json['encoding'],
      ) ??
...
Map<String, dynamic> _$ElementCollisionPixelMaskToJson(
  _ElementCollisionPixelMask instance,
) => <String, dynamic>{
...
_ElementCollisionProfile _$ElementCollisionProfileFromJson(
  Map<String, dynamic> json,
) => _ElementCollisionProfile(
  source:
      $enumDecodeNullable(
        _$ElementCollisionProfileSourceEnumMap,
        json['source'],
      ) ??
  ...
  padding: json['padding'] == null
      ...
      : WarpTriggerPadding.fromJson(json['padding'] as Map<String, dynamic>),
  shapeCells:
      (json['shapeCells'] as List<dynamic>?)
  ...
  cells:
      ...
      const [],
  manualAddedCells:
      (json['manualAddedCells'] as List<dynamic>?)
          ?.map((e) => GridPos.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const [],
  manualRemovedCells:
      (json['manualRemovedCells'] as List<dynamic>?)
          ?.map((e) => GridPos.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const [],
);

Map<String, dynamic> _$ElementCollisionProfileToJson(
  _ElementCollisionProfile instance,
) => <String, dynamic>{
  ...
  'manualAddedCells': instance.manualAddedCells.map((e) => e.toJson()).toList(),
  'manualRemovedCells': instance.manualRemovedCells
      .map((e) => e.toJson())
      .toList(),
};
