...
void main() {
  test('Editor locks native plugins to Swift Package Manager', () {
  ...
  test('Editor registers the macOS media plugins used by the Studio', () {
  ...
  test('Editor macOS project contains no CocoaPods integration', () {
