...
void main() {
  test(
    'organic draft and its source links survive project JSON roundtrip',
    () async {
      ...
      final reloadedController = mountBorderStudioDraftController(
        manifest: reloaded,
      );
      ...
      expect(
        record.draft.definition.primitives.single.sourceElementId,
        'rock-element',
      );
      expect(
        record.draft.definition.primitives.single.currentMetrics,
