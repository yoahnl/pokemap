...
void main() {
  ...
  test('certifies real assets, licenses, contrasts, and codecs', () async {
    ...
    _writeBytes(root, 'assets/presentation/intro/intro.mp4', <int>[
      0,
      0,
      0,
      24,
    ...
    _writeBytes(root, 'assets/presentation/fonts/display.ttf', <int>[
      0,
      1,
      0,
      0,
  ...
  test(
    'rejects corrupt signatures, blank licenses, and invalid WebVTT',
    () async {
      ...
      final result = await const FileSystemProjectPresentationPreflight()
          .inspect(projectRoot: root, profile: profile);
  ...
  test(
    'keeps core contrast and declared codec diagnostics authoritative',
    () async {
