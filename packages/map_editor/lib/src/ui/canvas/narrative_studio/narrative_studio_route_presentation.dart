...
NarrativeStudioRouteLocation? narrativeStudioRouteLocationFor(
  ...
  EditorWorkspaceMode.globalStory => NarrativeStudioRouteLocation.storylines(),
  ...
  EditorWorkspaceMode.cinematics => NarrativeStudioRouteLocation.cinematics(),
  ...
  EditorWorkspaceMode.worldRules => NarrativeStudioRouteLocation.worldRules(),
...
NarrativeStudioRoutePresentation narrativeStudioRoutePresentationForLocation(
  ...
  NarrativeStudioChildRoute.overview => const NarrativeStudioRoutePresentation(
  ...
  NarrativeStudioChildRoute.mapEvents => const NarrativeStudioRoutePresentation(
    destination: NarrativeStudioDestination.events,
