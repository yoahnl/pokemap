...
part 'step_studio/step_studio_workspace_support.dart';
...
class _StepStudioWorkspaceState extends State<StepStudioWorkspace> {
  ...
  void _appendOutcome(StepStudioOutcomeScope scope) {
    ...
    final label = switch (scope) {
      StepStudioOutcomeScope.local => 'Nouveau résultat',
  ...
  void _applyStarterChoiceDemoTemplate() {
    ...
    const fire = StepStudioOutcomeDefinition(
      label: 'Starter feu',
      scope: StepStudioOutcomeScope.local,
      outcomeId: 'starter.selected.fire',
    );
    const water = StepStudioOutcomeDefinition(
      label: 'Starter eau',
      scope: StepStudioOutcomeScope.local,
      outcomeId: 'starter.selected.water',
    );
    const grass = StepStudioOutcomeDefinition(
      label: 'Starter plante',
      scope: StepStudioOutcomeScope.local,
      outcomeId: 'starter.selected.grass',
    );
    const chapter = StepStudioOutcomeDefinition(
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                final useStackedLayout = constraints.maxWidth < lateral + 160;
          ...
          const InspectorEmbeddedFootnote(
            text:
                'Les textes au centre aident à lire l’étape. Début, fin, scènes, résultats et carte sont des réglages enregistrés — pas des raccourcis magiques.',
            accent: EditorChrome.inspectorJoyCyan,
          ),
        ],
      ),
    ...
    switch (focus.slot) {
        ...
        return Column(
          ...
          children: [
            _StepSectionCard(
              ...
              subtitle: 'Texte affiché au centre.',
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  _InlineTextField(
                    label: 'Texte affiché au centre (facultatif)',
      ...
      case StepFlowSlot.objective:
        return Column(
          ...
          children: [
            ...
            _StepSectionCard(
              title: 'Objectif',
              subtitle: 'Complément facultatif pour le centre.',
      ...
      case StepFlowSlot.cutscenesHub:
        ...
        return _StepSectionCard(
          title: 'Scènes liées',
          subtitle:
              'Plusieurs références possibles — pas le contenu dialogué ici.',
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              if (links.isEmpty)
      ...
      case StepFlowSlot.localOutcome:
        ...
        if (o.scope != StepStudioOutcomeScope.local) {
          return Text(
            'Ce résultat n’est pas un résultat de cette étape. Ouvrez « Résultats possibles » au centre.',
            style: TextStyle(color: EditorChrome.subtleLabel(context)),
          );
        }
        return _OutcomeRow(
      ...
      case StepFlowSlot.progressionOutcome:
        ...
        if (o.scope != StepStudioOutcomeScope.progression) {
          return Text(
            'Choisissez un résultat pour l’histoire au centre.',
            style: TextStyle(color: EditorChrome.subtleLabel(context)),
          );
        }
        return _OutcomeRow(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          // Gabarit pédagogique §11 : remplit objectifs / outcomes / condition de fin
  ...
  Widget _buildCompletionSection(
    ...
    return _StepSectionCard(
      ...
      subtitle: 'Règle actuelle (indépendante du texte au centre).',
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
