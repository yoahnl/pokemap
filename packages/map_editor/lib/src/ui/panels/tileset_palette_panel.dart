...
import '../widgets/element_collision_triple_mask_editor.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  _ElementCollisionAuthoringSection(
                    ...
                    preview: ElementCollisionTripleMaskEditor(
                      image: image,
                      source: source,
                      tileWidth: tileWidth,
                      tileHeight: tileHeight,
      ...
      children: [
        ...
        if (collisionAutoMode)
          ...
          Padding(
            padding: const EdgeInsets.only(bottom: 4),
            child: Text(
              'Mode manuel : peignez les pixels de collision ou d’occlusion dans '
              'l’aperçu ci-dessous (modes Aperçu / Collision / Occlusion).',
              style: TextStyle(
                color: secondary,
                fontSize: 11,
              ),
