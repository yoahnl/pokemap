...
final createProjectUseCaseProvider =
    AutoDisposeProvider<CreateProjectUseCase>.internal(
  createProjectUseCase,
  name: r'createProjectUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$createProjectUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
String _$updateProjectSettingsUseCaseHash() =>
    r'682188b36f7c3a3615523d6d039260b82938f2bb';

/// See also [updateProjectSettingsUseCase].
@ProviderFor(updateProjectSettingsUseCase)
final updateProjectSettingsUseCaseProvider =
    AutoDisposeProvider<UpdateProjectSettingsUseCase>.internal(
  updateProjectSettingsUseCase,
  name: r'updateProjectSettingsUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$updateProjectSettingsUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
String _$createTilesetElementGroupUseCaseHash() =>
    r'470a811dbc265fcc350f87ea19e7a005d02c2d43';

/// See also [createTilesetElementGroupUseCase].
@ProviderFor(createTilesetElementGroupUseCase)
final createTilesetElementGroupUseCaseProvider =
    AutoDisposeProvider<CreateTilesetElementGroupUseCase>.internal(
  createTilesetElementGroupUseCase,
  name: r'createTilesetElementGroupUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$createTilesetElementGroupUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef CreateTilesetElementGroupUseCaseRef
    = AutoDisposeProviderRef<CreateTilesetElementGroupUseCase>;
String _$createTilesetElementSubgroupUseCaseHash() =>
    r'383aee22f6e24b09a168b12f70503fef3fb61bef';

/// See also [createTilesetElementSubgroupUseCase].
@ProviderFor(createTilesetElementSubgroupUseCase)
final createTilesetElementSubgroupUseCaseProvider =
    AutoDisposeProvider<CreateTilesetElementSubgroupUseCase>.internal(
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef CreateTilesetElementSubgroupUseCaseRef
    = AutoDisposeProviderRef<CreateTilesetElementSubgroupUseCase>;
String _$renameTilesetElementGroupUseCaseHash() =>
    r'91bd47f43374f5606473c493b466e719578b76d5';

/// See also [renameTilesetElementGroupUseCase].
@ProviderFor(renameTilesetElementGroupUseCase)
final renameTilesetElementGroupUseCaseProvider =
    AutoDisposeProvider<RenameTilesetElementGroupUseCase>.internal(
  renameTilesetElementGroupUseCase,
  name: r'renameTilesetElementGroupUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$renameTilesetElementGroupUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef RenameTilesetElementGroupUseCaseRef
    = AutoDisposeProviderRef<RenameTilesetElementGroupUseCase>;
...
String _$createPresetCategoryUseCaseHash() =>
    r'5669053c838784d3c47acbfd076a7478a1ba4abf';

/// See also [createPresetCategoryUseCase].
@ProviderFor(createPresetCategoryUseCase)
final createPresetCategoryUseCaseProvider =
    AutoDisposeProvider<CreatePresetCategoryUseCase>.internal(
  createPresetCategoryUseCase,
  name: r'createPresetCategoryUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$createPresetCategoryUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef CreatePresetCategoryUseCaseRef
    = AutoDisposeProviderRef<CreatePresetCategoryUseCase>;
String _$renamePresetCategoryUseCaseHash() =>
    r'955c9eaade0751cc0766b12f46ae264fe101a05c';

/// See also [renamePresetCategoryUseCase].
@ProviderFor(renamePresetCategoryUseCase)
final renamePresetCategoryUseCaseProvider =
    AutoDisposeProvider<RenamePresetCategoryUseCase>.internal(
  renamePresetCategoryUseCase,
  name: r'renamePresetCategoryUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$renamePresetCategoryUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef RenamePresetCategoryUseCaseRef
    = AutoDisposeProviderRef<RenamePresetCategoryUseCase>;
String _$deletePresetCategoryUseCaseHash() =>
    r'c7f023db12c87e2d6417710e7cab2afa95f2a9f1';

/// See also [deletePresetCategoryUseCase].
@ProviderFor(deletePresetCategoryUseCase)
final deletePresetCategoryUseCaseProvider =
    AutoDisposeProvider<DeletePresetCategoryUseCase>.internal(
  deletePresetCategoryUseCase,
  name: r'deletePresetCategoryUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$deletePresetCategoryUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef DeletePresetCategoryUseCaseRef
    = AutoDisposeProviderRef<DeletePresetCategoryUseCase>;
...
String _$resolveTilesetElementsUseCaseHash() =>
    r'308afc07ad626c642a1db8ca67b92ecadadb094c';

/// See also [resolveTilesetElementsUseCase].
@ProviderFor(resolveTilesetElementsUseCase)
final resolveTilesetElementsUseCaseProvider =
    AutoDisposeProvider<ResolveTilesetElementsUseCase>.internal(
  resolveTilesetElementsUseCase,
  name: r'resolveTilesetElementsUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$resolveTilesetElementsUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef ResolveTilesetElementsUseCaseRef
    = AutoDisposeProviderRef<ResolveTilesetElementsUseCase>;
...
String _$validateWarpTargetMapUseCaseHash() =>
    r'500256c98721902daeb1ddb7266f07924d2dc384';

/// See also [validateWarpTargetMapUseCase].
@ProviderFor(validateWarpTargetMapUseCase)
final validateWarpTargetMapUseCaseProvider =
    AutoDisposeProvider<ValidateWarpTargetMapUseCase>.internal(
  validateWarpTargetMapUseCase,
  name: r'validateWarpTargetMapUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$validateWarpTargetMapUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@ProviderFor(createMapUseCase)
final createMapUseCaseProvider = AutoDisposeProvider<CreateMapUseCase>.internal(
  createMapUseCase,
  name: r'createMapUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$createMapUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@ProviderFor(loadMapUseCase)
final loadMapUseCaseProvider = AutoDisposeProvider<LoadMapUseCase>.internal(
  loadMapUseCase,
  name: r'loadMapUseCaseProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$loadMapUseCaseHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
