...
List<ProjectTerrainPreset> defaultTerrainPresets() {
  return const [
...
List<ProjectTerrainPresetCategory> defaultTerrainPresetCategories() {
  return const [
...
List<ProjectPathPreset> defaultPathPresets() {
  return const [
    ProjectPathPreset(
      id: 'path_default',
      name: 'Dirt Path',
...
ProjectManifest withDefaultProjectLibrary(ProjectManifest project) {
  ...
  final terrainPresetCategories = project.terrainPresetCategories.isEmpty
      ? defaultTerrainPresetCategories()
      : project.terrainPresetCategories;
  final terrainPresets = project.terrainPresets.isEmpty
      ? defaultTerrainPresets()
      : project.terrainPresets;
  final pathPresets =
      project.pathPresets.isEmpty ? defaultPathPresets() : project.pathPresets;
