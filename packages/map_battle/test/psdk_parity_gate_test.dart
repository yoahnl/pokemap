...
void main() {
  group('PSDK parity gate', () {
    test('passes the current Pokemon SDK parity baseline', () async {
      ...
      expect(audit.attackMetrics.fait, 389);
      expect(audit.attackMetrics.unknownMethods, 0);
      expect(audit.methodMetrics.byStatus[PsdkPortStatus.ported], 207);
      expect(audit.effectMetrics.byStatus[PsdkPortStatus.ported], 401);
      expect(audit.effectMetrics.byStatus[PsdkPortStatus.partial], 16);
    });
