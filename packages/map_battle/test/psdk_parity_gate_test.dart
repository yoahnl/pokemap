...
void main() {
  group('PSDK parity gate', () {
    test('passes the current Pokemon SDK parity baseline', () async {
      ...
      expect(audit.attackMetrics.fait, 385);
      expect(audit.attackMetrics.unknownMethods, 0);
      expect(audit.methodMetrics.byStatus[PsdkPortStatus.ported], 201);
      expect(audit.effectMetrics.byStatus[PsdkPortStatus.ported], 378);
      expect(audit.effectMetrics.byStatus[PsdkPortStatus.partial], 27);
    });
