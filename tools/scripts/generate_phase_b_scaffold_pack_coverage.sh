...
# - écrit enfin le report markdown sous documentation/reports/battle/.

REPO_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)"
REPORT_DIR="$REPO_ROOT/documentation/reports/battle"
...
(
  ...
  "$FLUTTER_BIN" pub run tool/phase_b_scaffold_pack_coverage.dart \
    ...
    --level 10 \
    --output "$REPORT_DIR/phase-b-scaffold-pack-coverage.md"
)

echo "Coverage report written to $REPORT_DIR/phase-b-scaffold-pack-coverage.md"
