...
Suite V1-129 : les emotes actives sont visibles dans la preview playback du Cinematic Builder. Après la chaîne Emotes V1-125 à V1-129, le prochain verrou produit redevient l’enrichissement caméra : cible, centre, zoom, cadrage et authoring no-code. V1-130 est recommandé mais non démarré.
...
Suite historique : les lots recommandes V1-126, V1-127 et V1-128 ont ete realises. Prochain lot global actuel : `NS-SCENES-V1-130 — Cinematic Camera Target / Zoom Authoring Prep Contract`.
...
Suite historique : V1-117 puis V1-118 ont ete realises ; V1-119 a ete realise ; V1-120 puis V1-121 ont ete realises ; V1-122 a ete realise en documentaire ; le prochain lot global actuel est `NS-SCENES-V1-130 — Cinematic Camera Target / Zoom Authoring Prep Contract`.
