...
| NS-SCENES-V1-70 | Cinematic Timeline Duration Validation / Diagnostics Polish V0 | editor / ui-polish | Consolider les messages d'erreur, bornes, feedback no-code et diagnostics autour de l'edition/resize de duree. | Pas de nouveau modele temporel, pas de playback, pas de seek runtime, pas de timeline libre, pas de drag/reorder de blocs. | Builder cinematics, tests widget, rapport, screenshot si lot UI. | TODO : feedback plus lisible sur min/max, cas clamp, erreurs et aides autour des durees. | Dupliquer la validation core ; transformer le polish en nouveau pouvoir de montage. | TODO : edition de duree plus explicite, sans elargir le contrat V1-68/V1-69. | V1-69. |
