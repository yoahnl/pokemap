...
Raison : V1-59 ferme la navigation verticale locale. Le prochain verrou naturel est d'expliquer proprement les raccourcis clavier et les bords de navigation, sans ajouter de playback, seek, scrubber, drag/drop, resize, reorder, runtime ni mutation.

Ordre apres V1-59 : `NS-SCENES-V1-60 — Cinematic Timeline Keyboard Navigation Polish / Help Overlay V0`.
