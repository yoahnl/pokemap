...
| NS-SCENES-V1-122 — Cinematic Camera Preview Playback Prep Contract | DONE | Cadrer la future prévisualisation caméra editor-only du Cinematic Builder, en séparant strictement viewport d’édition, caméra cinématique, playback camera state, runtime camera et rendu preview, sans code produit. |
| NS-SCENES-V1-123 — Cinematic Camera Playback State Read Model V0 | DONE | Implémenter dans `map_core` un état caméra de playback preview pur et déterministe, exposé par `frameAt(timeMs)`, avec `activeStepId`, `progress`, support/unsupported diagnostics et séparation stricte du viewport editor, sans UI, renderer, runtime, Flame ni GameState. |
| NS-SCENES-V1-124 — Cinematic Camera Preview Playback UI V0 | DONE | Brancher l’état caméra de playback preview V1-123 au Cinematic Builder avec un overlay/cadre caméra editor-only, labels no-code et diagnostics supportés/partiels, sans muter le viewport d’édition, sans runtime, Flame, GameState, map_core ni prétendre à un vrai pan/zoom. |
| NS-SCENES-V1-125 — Cinematic Emote Assets / Reaction Bubble Prep Contract V0 | DONE | Cadrer le futur système d’emotes cinématiques à partir des assets racine `emotions.png` et `emotions2.png`, avec audit atlas, catalogue no-code, modèle actorEmote, diagnostics, UX inspecteur, preview playback future et trajectoire core/UI, sans code produit ni déplacement d’assets. |
...
| NS-SCENES-V1-127 — Cinematic Emote Playback State Read Model V0 | DONE | Exposer les emotes actives du bloc actorEmote dans le read model pur `frameAt(timeMs)`, avec activeStepId, actorId, emoteId, progress, support/diagnostics et coexistence actorPoses/fadeState/cameraPose, sans UI, renderer, runtime, Flame, GameState, assets déplacés ni pubspec modifié. |
| NS-SCENES-V1-128 — Cinematic Emote Block Editor UI V0 | DONE | Ajouter le bloc Émotion actorEmote dans la palette et l’inspecteur du Cinematic Builder, avec picker acteur, picker réaction no-code depuis le catalogue V0, durée, diagnostics et résumé timeline humain, sans rendu visuel des bulles, asset loading, runtime, Flame, GameState, déplacement d’assets ni modification pubspec. |
| NS-SCENES-V1-129 — Cinematic Emote Preview Playback UI V0 | DONE | Afficher les emotes actives au-dessus des acteurs dans la preview playback du Cinematic Builder, en consommant `frame.activeEmotes` et `frame.actorPoses`, avec rendu atlas editor-only, assets officiels, fallbacks diagnostics, Play/Pause/Stop/Reset/seek/scrub fonctionnels, sans runtime, Flame, GameState, Camera Target/Zoom ni recalcul de timeline. |
...
| NS-SCENES-V1-131 — Cinematic Camera Target / Zoom Core Model V0 | DONE | Core model camera cible/zoom implemente : enums `focus`, target kind sceneCenter/actor/stagePoint, zoom preset wide/medium/close, bindings typés, helpers metadata, operations pures et diagnostics core, sans UI authoring complete, preview camera reelle, runtime, Flame, GameState, coordonnees libres ni waypoints libres. |
| NS-SCENES-V1-132 — Cinematic Camera Target / Zoom Editor UI V0 | DONE | Core model V1-131 branche dans l'inspecteur Camera du Cinematic Builder : modes reset/hold/focus en francais, cible scene/acteur/repere, presets Plan large/moyen/gros plan, Visual Gate, sans preview camera reelle, runtime, Flame, GameState, geometrie camera ni mutation du viewport editor. |
...
| NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure | RECOMMANDÉ | Fermer les decisions utilisateur avant authoring : Lysa/Lyra/rival, mapping Port des Brisants, IDs Mael/Lysa/battle/facts/world rules et strict perimetre V1-139. |

## Prochain lot exact recommande

`NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`

Raison : V1-138 a reconcilié les donnees actuelles avec la bible et les rapports NS-GS, mais l'audit conclut que V1-139 doit attendre une confirmation Karim sur Lysa/Lyra/rival, le mapping du Port des Brisants et les noms de facts/world rules.
...
21. `NS-SCENES-V1-120 — Cinematic Preview Playback Scrub / Seek UI V0` (DONE)
22. `NS-SCENES-V1-121 — Cinematic Fade Preview Playback V0` (DONE)
23. `NS-SCENES-V1-122 — Cinematic Camera Preview Playback Prep Contract` (DONE documentaire)
24. `NS-SCENES-V1-123 — Cinematic Camera Playback State Read Model V0` (DONE)
25. `NS-SCENES-V1-124 — Cinematic Camera Preview Playback UI V0` (DONE)
26. `NS-SCENES-V1-125 — Cinematic Emote Assets / Reaction Bubble Prep Contract V0` (DONE documentaire)
27. `NS-SCENES-V1-126 — Cinematic Emote Core Model / Asset Catalog V0` (DONE)
28. `NS-SCENES-V1-127 — Cinematic Emote Playback State Read Model V0` (DONE)
29. `NS-SCENES-V1-128 — Cinematic Emote Block Editor UI V0` (DONE)
30. `NS-SCENES-V1-129 — Cinematic Emote Preview Playback UI V0` (DONE)
31. `NS-SCENES-V1-130 — Cinematic Camera Target / Zoom Authoring Prep Contract` (DONE documentaire)
32. `NS-SCENES-V1-131 — Cinematic Camera Target / Zoom Core Model V0` (DONE)
33. `NS-SCENES-V1-132 — Cinematic Camera Target / Zoom Editor UI V0` (DONE)
34. `NS-SCENES-V1-133 — Cinematic Camera Geometry Playback State V0` (DONE)
...
40. `NS-SCENES-V1-138 — Selbrume Golden Slice Content Inventory / Asset Gap Audit` (DONE)
41. `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure` (recommande, non demarre)

## Mise a jour V1-138

Statut : `NS-SCENES-V1-138 — Selbrume Golden Slice Content Inventory / Asset Gap Audit` est DONE documentaire.

Verdict : `V1-139_SHOULD_WAIT`.

Decision : l'inventaire a distingue contenu existant, prototypes et IDs canoniques proposes. Mael existe comme character mais pas comme entite/event/dialogue ; Lysa n'existe pas sous ID canonique et reste ambigue avec `lyra` / `rival` ; le Port des Brisants n'existe pas comme map dediee meme si `Selbrume` contient ponton/ocean/assets portuaires.

Preuve : rapport V1-138, Evidence Pack V1-138, inventaires `project.json`, maps, Yarn, assets tilesets, rapports NS-GS et anti-scope doc-only.
...
Statut : `NS-SCENES-V1-136 — Cinematic Builder V1 Closure / Readiness Audit` est DONE documentaire.

Verdict : **Cinematic Builder V1 : CLOSABLE AVEC RESERVES NON BLOQUANTES**.

Decision : le Builder V1 peut etre ferme avec reserves documentees. Les reserves portent sur des attentes de tests widget historiques a realigner avec l'UX no-code actuelle, pas sur un blocker produit ou runtime.

Preuve : suite ciblee Builder V1-102 a V1-135 verte, tests core cinematic elargis verts, analyse `map_core` verte, build macOS debug vert, Visual Gates V1 inventoriees et anti-scope runtime intact. Les suites completes Builder/Library contiennent respectivement 6 et 1 attentes legacy rouges, classees MAJOR non bloquantes.
...
Decision : la sequence camera V1 est fermee par un polish/gate cible. Le wording final distingue le cadrage visible de la vraie camera non pilotee : l'overlay geometrique conserve `Cadrage affiché, vue non pilotée.`, l'overlay symbolique indique `Cadrage visible dans la preview.`, et l'inspecteur Camera indique `Cadrage visible dans la preview. La vue reste non pilotée.`.
...
Prochain lot global actuel : `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`.

## Mise a jour V1-134

Statut : `NS-SCENES-V1-134 — Cinematic Camera Geometry Preview UI V0` est DONE.

Decision : la preview du Cinematic Builder consomme `cameraPose.geometry` et affiche un cadre camera editor-only, un marqueur de cible, un libelle no-code et les diagnostics d'indisponibilite sans recalculer la geometrie depuis les metadata.
...
Decision : `CinematicPreviewPlaybackFrame.cameraPose.geometry` expose une geometrie derivee immutable pour les cameras focus, tout en gardant `cameraPose.isSupported == false` pour ne pas promettre de vraie preview camera avant V1-134.
...
Decision : l'UI d'authoring Camera consomme le core model V1-131 sans creer de geometrie camera. Les modes `Réinitialiser le cadrage`, `Maintenir le cadrage` et `Cadrer une cible` sont exposés en no-code ; le focus cible `Centre de la scène`, `Acteur` ou `Repère` et choisit `Plan large`, `Plan moyen` ou `Gros plan`.

Preuve : tests widget V1-132, regressions V1-124/V1-129, capture Visual Gate `ns_scenes_v1_132_cinematic_camera_target_zoom_editor_ui_v0.png`, analyse ciblée et anti-scope runtime/assets/Selbrume.
...
Decision : le stockage reste backward-compatible via metadata Camera, avec helpers typés comme API principale. Le mode `focus` reste une intention authoring symbolique ; aucun centre/zoom numerique ni geometrie camera n'est produit dans ce lot.

Preuve : core model `sceneCenter | actor | stagePoint`, zoom `wide | medium | close`, operations pures add/update, diagnostics target/zoom/mode, tests JSON/authoring/diagnostics/playback V1-131, régressions core ciblées et analyse ciblée.
...
Suite realisee : V1-132 est DONE. Prochain lot global actuel : `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`.

## Mise a jour V1-130

Statut : `NS-SCENES-V1-130 — Cinematic Camera Target / Zoom Authoring Prep Contract` est DONE documentaire.

Decision : Option D + Option G retenue. La camera future doit proposer des cibles no-code `Centre de la scene`, `Acteur` et `Repere`, et des presets de zoom `Plan large`, `Plan moyen`, `Gros plan`. Le viewport editor local reste separe de la camera cinematographique.

Preuve : audit read-only Camera V0 (`reset`/`hold`, metadata `camera.mode`, `cameraPose` symbolique), Stage Points, Actor Display, playback read model, viewport framing V1-95/V1-124, rapports crees et roadmaps alignees. Aucun code produit, aucun package, aucun screenshot, aucun runtime, Flame, GameState, asset ou Selbrume n'a ete modifie par V1-130.
...
Résultat : les emotes actives du playback preview sont rendues au-dessus des acteurs dans le Cinematic Builder à partir de `frame.activeEmotes` et `frame.actorPoses`. Le rendu utilise les frame rects du catalogue, des assets editor officiels, un fallback non bloquant et reste local au preview editor-only.

Preuve : tests RED/GREEN V1-129, régressions V1-128/V1-124/V1-121/V1-120, Library/Stage overlay, tests core emote/playback/authoring/diagnostics, analyse ciblée, `dart analyze`, build macOS debug, Visual Gate `ns_scenes_v1_129_cinematic_emote_preview_playback_ui_v0.png`, anti-scope runtime/gameplay/battle/examples/Selbrume vide.
...
Demande : rendre le bloc actorEmote authorable dans le Cinematic Builder via une entrée de palette `Émotion`, un inspecteur no-code, un picker acteur, un picker réaction issu du catalogue emote V0, une durée éditable, des diagnostics et un résumé timeline humain, sans lancer le rendu visuel des bulles.

Decision : le Builder consomme les opérations pures V1-126 (`addCinematicTimelineActorEmoteStep` / `updateCinematicTimelineActorEmoteStep`) depuis l’écran parent, garde les IDs techniques hors workflow principal et n’utilise que les labels du catalogue V0. Les assets racine ne sont pas chargés, déplacés ou copiés.

Preuve : tests RED/GREEN V1-128, régressions Builder V1-124/V1-121/V1-120, Library/Stage overlay, tests core emote V1-126/V1-127, analyse ciblée, `dart analyze`, build macOS debug et Visual Gate `ns_scenes_v1_128_cinematic_emote_block_editor_ui_v0.png` créés. Anti-scope runtime/assets/pubspec/Selbrume vide.
...
Demande : exposer les emotes actives dans le read model pur de playback via `CinematicPreviewPlaybackFrame.activeEmotes`, sans UI, renderer, overlay, asset loading, runtime, Flame, GameState, screenshot ni Visual Gate.

Decision : ajouter un état immutable `CinematicActorEmotePlaybackState` directement dans `cinematic_preview_playback_plan.dart`, attaché à l’acteur et à l’emote par IDs/labels, avec progression temporelle, support et diagnostics locaux. L’état ne duplique pas la pose acteur : le futur renderer combinera `frame.actorPoses` et `frame.activeEmotes`.

Preuve : tests RED/GREEN V1-127 ajoutés dans `cinematic_preview_playback_plan_test.dart`, tests core ciblés, suite complète `map_core`, `dart analyze` et régressions Builder ciblées relancés. Les checks anti-scope confirment qu’aucun `map_editor`, runtime, gameplay, battle, example, asset, Selbrume ou pubspec n’a été modifié.
...
Suite realisee : V1-128 a rendu le bloc actorEmote authorable dans le Builder. Suite realisee : V1-132 est DONE. Prochain lot global actuel : `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`.

## Mise a jour V1-126

Statut : `NS-SCENES-V1-126 — Cinematic Emote Core Model / Asset Catalog V0` est DONE.

Demande : implémenter côté `map_core` le modèle authoring minimal `actorEmote` et un catalogue emote V0 pur, déterministe et testable, sans UI, renderer, runtime, Flame, GameState, déplacement d’assets, modification pubspec, screenshot ni Visual Gate.

Decision : réutiliser le kind existant `CinematicTimelineStepKind.actorEmote`, stocker `actorId` dans le champ modèle existant et `emoteId` dans metadata `actor.emoteId`, avec catalogue typé `CinematicEmoteCatalogEntry`, opérations pures add/update et diagnostics dédiés acteur/emote/durée. L’état playback actif des emotes est volontairement reporté.

Preuve : tests catalogue, authoring, diagnostics et playback boundary ajoutés ; `map_core` ciblé, suite complète `map_core`, `dart analyze` et régressions Builder ciblées relancés ; anti-scope map_editor/runtime/assets/pubspec/screenshots vérifié.
...
Suite realisee : V1-127 puis V1-128 ont ete realises. Prochain lot global actuel : `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`.

## Mise a jour V1-125

Statut : `NS-SCENES-V1-125 — Cinematic Emote Assets / Reaction Bubble Prep Contract V0` est DONE documentaire.

Demande : cadrer le futur système d’emotes cinématiques à partir des assets racine `emotions.png` et `emotions2.png`, sans code produit, sans déplacement d’assets, sans screenshot et sans démarrer V1-126.

Decision : retenir `Option B future + Option C + Option F` : intégrer les assets dans un chemin officiel plus tard, créer un catalogue typé no-code basé sur atlas/frame rects, et séparer les emotes attachées acteur des FX libres. Le futur bloc recommandé est `actorEmote`, attaché à un acteur, avec `emoteId`, `durationMs` et placement au-dessus de l’acteur.

Preuve : rapport V1-125 et Evidence Pack V1-125 créés, assets audités par `ls`, `file`, `shasum` et `sips`, règles lues, roadmaps alignées et anti-scope documentaire vérifié.
...
Suite historique : les lots recommandes V1-126, V1-127 et V1-128 ont ete realises. Prochain lot global actuel : `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`. Camera Target / Zoom est cadre par V1-130 ; le core model a ete realise par `NS-SCENES-V1-131 — Cinematic Camera Target / Zoom Core Model V0`.

## Mise a jour V1-124

Statut : `NS-SCENES-V1-124 — Cinematic Camera Preview Playback UI V0` est DONE.

Demande : brancher l’état `CinematicPreviewPlaybackFrame.cameraPose` dans le Cinematic Builder afin d’afficher une prévisualisation caméra V0 honnête, no-code et editor-only pendant le playback preview.

Decision : l’UI consomme directement `playbackFrame.cameraPose` et affiche un cadre symbolique + badge `Caméra active` dans la preview uniquement. Les modes supportés V0 affichent `Cadrage caméra prêt`; les diagnostics unsupported réutilisent les messages no-code du read model. Aucun centre, zoom, cible ou pan n’est inventé.

Preuve : tests RED/GREEN V1-124 ajoutés, régressions V1-121/V1-120/V1-118/V1-117/V1-117-bis/V1-116 relancées, suite Builder complète relancée, tests core ciblés relancés, analyse ciblée, build macOS debug et Visual Gate V1-124.
...
Suite realisee : V1-125 a cadré les emotes cinématiques, puis V1-126 a posé le core/catalogue ; prochain lot global actuel : `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`.

## Mise a jour V1-123

Statut : `NS-SCENES-V1-123 — Cinematic Camera Playback State Read Model V0` est DONE.

Demande : implémenter dans `map_core` un état caméra de playback preview pur, déterministe et testable, consommable plus tard par le Cinematic Builder.

Decision : `CinematicPreviewPlaybackFrame.cameraPose` expose désormais un état actif/inactif avec `activeStepId`, `isSupported`, compatibilité `supported`, `mode`, `progress` clampé et diagnostics. Les modes V0 supportés sont les modes authoring existants `reset` et `hold`; les modes manquants ou inconnus restent diagnostiqués sans crash.

Preuve : tests RED/GREEN V1-123 ajoutés dans `cinematic_preview_playback_plan_test.dart`, tests `map_core` ciblés et complets relancés, `dart analyze` vert, régressions Builder V1-120/V1-121 relancées, anti-scope packages/screenshots vide.
...
Prochain lot recommande historique apres V1-123 : `NS-SCENES-V1-124 — Cinematic Camera Preview Playback UI V0` (realise) ; prochain lot global actuel : `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`.

## Mise a jour V1-122

Statut : `NS-SCENES-V1-122 — Cinematic Camera Preview Playback Prep Contract` est DONE documentaire.

Demande : cadrer la future prévisualisation caméra editor-only du Cinematic Builder, sans implémenter la caméra et sans modifier les packages.

Decision : le modèle actuel ne suffit pas pour une UI caméra directe. Le plan V1-110 expose `CinematicCameraPlaybackPose`, mais seulement avec `supported` et `activeStepId`; les tests existants vérifient `supportsCamera == false` et le diagnostic `cinematicPreviewPlaybackCameraUnsupported`. La suite retenue est donc un split prudent : read model caméra puis UI.

Preuve : rapport V1-122 et Evidence Pack V1-122 créés ; audit des rapports V1-110/V1-121 et des zones `cinematic_preview_playback_plan.dart`, `cinematic_authoring_operations.dart`, `cinematic_builder_workspace.dart`, `cinematic_backdrop_preview_framing.dart` et tests associés ; options A/B/C/D/E/F comparées.

Limites : aucun code produit, package Dart/Flutter, runtime, Flame, GameState, screenshot, Visual Gate ou V1-123 n'a été démarré.

Suite realisee : `NS-SCENES-V1-123 — Cinematic Camera Playback State Read Model V0` est DONE ; `NS-SCENES-V1-124 — Cinematic Camera Preview Playback UI V0` est maintenant DONE ; prochain lot global actuel : `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`.

## Mise a jour V1-121

Statut : `NS-SCENES-V1-121 — Cinematic Fade Preview Playback V0` est DONE.

Demande : prévisualiser les blocs Fondu pendant la lecture locale du Cinematic Builder, en consommant uniquement `CinematicPreviewPlaybackFrame.fadeState`.

Decision : le fade est peint par un overlay editor-only dans la preview map frame, au-dessus du décor/acteurs/trajets mais jamais sur la timeline, la palette ou l'inspecteur. Le helper utilise les tokens de thème et reste passif via `IgnorePointer`.

Preuve : tests V1-121, regressions V1-120/V1-118/V1-117/V1-117-bis/V1-116, Builder complet, Library/overlay, fallback summary, core ciblé, analyse ciblée, build macOS debug et Visual Gate V1-121 documentes dans le rapport et l'Evidence Pack.
...
Suite historique : V1-122 a ete realise en documentaire ; le prochain lot global actuel est `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`.

## Mise a jour V1-120

Statut : `NS-SCENES-V1-120 — Cinematic Preview Playback Scrub / Seek UI V0` est DONE.

Demande : implementer le click-to-seek sur l'axe temporel et le fond vide de timeline, ainsi que le drag-to-scrub du Playback Playhead `Lecture`, en gardant `Selection Cursor`, `Mouse Time Probe` et `Playback Playhead` separes.

Decision : le seek standard met a jour uniquement le temps local editor-only de preview. Le clic sur une barre reste une selection de bloc. Le drag du handle `Lecture` scrubbe la preview, pause pendant le drag si la lecture etait active, puis reprend au release.

Preuve : tests V1-120, regressions V1-118/V1-117/V1-117-bis/V1-116, Builder complet, tests Library/overlay, fallback summary, core ciblé, analyse ciblee, build macOS debug et Visual Gate V1-120 documentes dans le rapport et l'Evidence Pack.
...
Suite historique : V1-121 puis V1-122 ont ete realises ; le prochain lot global actuel est `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`.
...
Suite historique : V1-120 puis V1-121 ont ete realises ; V1-122 a ete realise en documentaire ; le prochain lot global actuel est `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`.
...
Suite historique : V1-119 a ete realise en documentaire ; V1-120 puis V1-121 ont ete realises ; V1-122 a ete realise en documentaire ; le prochain lot global actuel est `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`.
...
Suite historique : V1-118 a ete realise ; V1-119 a ete realise ; V1-120 puis V1-121 ont ete realises ; V1-122 a ete realise en documentaire ; le prochain lot global actuel est `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`.
...
Suite historique : V1-117 puis V1-118 sont realises ; V1-119 a ete realise ; V1-120 puis V1-121 ont ete realises ; V1-122 a ete realise en documentaire ; le prochain lot global actuel est `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`.
...
Suite historique : V1-116, V1-117 et V1-118 ont ete realises ; V1-119 a ete realise ; V1-120 puis V1-121 ont ete realises ; V1-122 a ete realise en documentaire ; le prochain lot global actuel est `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`.
...
Suite historique : V1-114, V1-115, V1-116, V1-117 et V1-118 ont ete realises ; V1-119 a ete realise ; V1-120 puis V1-121 ont ete realises ; V1-122 a ete realise en documentaire ; le prochain lot global actuel est `NS-SCENES-V1-138-bis — Selbrume Golden Slice Canonical ID Decision Closure`.
