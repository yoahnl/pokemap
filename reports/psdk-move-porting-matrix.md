...
| Method | Ruby class | Ruby path | Dart behavior | Status |
| --- | --- | --- | --- | --- |
...
| `s_body_press` | `BodyPress` | `10 Move/2 Definitions/300 BodyPress.rb` | `CustomStatSourceMoveBehavior.bodyPress` | `partial` |
...
| `s_custom_stats_based` | `CustomStatsBased` | `10 Move/2 Definitions/300 CustomStatsBased.rb` | `CustomStatSourceMoveBehavior.customStatsBased` | `partial` |
...
| `s_expanding_force` | `ExpandingForce` | `10 Move/2 Definitions/300 TerrainDamageMoves.rb` | `TODO` | `missing` |
...
| `s_false_swipe` | `FalseSwipe` | `10 Move/2 Definitions/300 FalseSwipe.rb` | `BasicDamageSpecializationMoveBehavior.falseSwipe` | `partial` |
...
| `s_final_gambit` | `FinalGambit` | `10 Move/2 Definitions/300 FinalGambit.rb` | `DirectHpMoveBehavior.finalGambit` | `partial` |
...
| `s_foul_play` | `FoulPlay` | `10 Move/2 Definitions/300 FoulPlay.rb` | `CustomStatSourceMoveBehavior.foulPlay` | `partial` |
...
| `s_grassy_glide` | `GrassyGlide` | `10 Move/2 Definitions/300 TerrainDamageMoves.rb` | `TODO` | `missing` |
...
| `s_heavy_slam` | `HeavySlam` | `10 Move/2 Definitions/300 HeavySlam.rb` | `WeightPowerMoveBehavior.heavySlam` | `partial` |
| `s_helping_hand` | `HelpingHand` | `10 Move/2 Definitions/300 HelpingHand.rb` | `TODO` | `missing` |
| `s_hex` | `Hex` | `10 Move/2 Definitions/300 Hex.rb` | `VariablePowerMoveBehavior.hex` | `partial` |
...
| `s_low_kick` | `LowKick` | `10 Move/2 Definitions/300 LowKick.rb` | `WeightPowerMoveBehavior.lowKick` | `partial` |
...
| `s_misty_explosion` | `MistyExplosion` | `10 Move/2 Definitions/300 TerrainDamageMoves.rb` | `SelfDestructMoveBehavior.mistyExplosion` | `partial` |
| `s_multi_attack` | `MultiAttack` | `10 Move/2 Definitions/300 MultiAttack.rb` | `TODO` | `missing` |
| `s_multi_hit` | `MultiHit` | `10 Move/1 Mechanics/103 TwoHit MultiHit.rb` | `MultiHitMoveBehavior.psdkRandom` | `partial` |
...
| `s_pain_split` | `PainSplit` | `10 Move/2 Definitions/300 PainSplit.rb` | `TODO` | `missing` |
...
| `s_population_bomb` | `PopulationBomb` | `10 Move/1 Mechanics/103 TwoHit MultiHit.rb` | `MultiHitMoveBehavior.populationBomb` | `partial` |
...
| `s_psyshock` | `CustomStatsBased` | `10 Move/2 Definitions/300 CustomStatsBased.rb` | `CustomStatSourceMoveBehavior.psyshock` | `partial` |
| `s_psywave` | `Psywave` | `10 Move/2 Definitions/300 HPEqLevel.rb` | `FixedDamageMoveBehavior.psywave` | `ported` |
| `s_purify` | `Purify` | `10 Move/2 Definitions/300 Purify.rb` | `TODO` | `missing` |
...
| `s_recoil` | `RecoilMove` | `10 Move/2 Definitions/300 RecoilMove.rb` | `RecoilMoveBehavior.psdkRecoil` | `partial` |
...
| `s_rising_voltage` | `RisingVoltage` | `10 Move/2 Definitions/300 TerrainDamageMoves.rb` | `TODO` | `missing` |
...
| `s_shore_up` | `ShoreUp` | `10 Move/2 Definitions/300 Shore Up.rb` | `TODO` | `missing` |
...
| `s_solar_beam` | `SolarBeam` | `10 Move/2 Definitions/300 SolarBeam.rb` | `TODO` | `missing` |
...
| `s_terrain` | `TerrainMove` | `10 Move/2 Definitions/300 TerrainMove.rb` | `TODO` | `missing` |
...
| `s_terrain_pulse` | `TerrainPulse` | `10 Move/2 Definitions/300 TerrainPulse.rb` | `TODO` | `missing` |
...
| `s_thunder` | `Thunder` | `10 Move/2 Definitions/300 Thunder.rb` | `TODO` | `missing` |
...
| `s_transform` | `Transform` | `10 Move/2 Definitions/300 Transform.rb` | `TODO` | `missing` |
...
| `s_triple_kick` | `TripleKick` | `10 Move/1 Mechanics/103 TwoHit MultiHit.rb` | `MultiHitMoveBehavior.tripleKick` | `partial` |
...
| `s_water_shuriken` | `WaterShuriken` | `10 Move/1 Mechanics/103 TwoHit MultiHit.rb` | `MultiHitMoveBehavior.waterShuriken` | `partial` |
| `s_weather` | `WeatherMove` | `10 Move/2 Definitions/300 WeatherMove.rb` | `TODO` | `missing` |
| `s_weather_ball` | `WeatherBall` | `10 Move/2 Definitions/300 WeatherBall.rb` | `TODO` | `missing` |
