...
Generated: 2026-05-20T23:07:26.691635Z

## Final Gate Axes

| Axis | Complete | Percent | Remaining |
| --- | ---: | ---: | ---: |
| Attacks | 382 / 728 | 52.5% | 346 |
| Methods | 198 / 330 | 60.0% | 132 |
...
| Damage formula / variable power | 32 | `s_aqua_ring`, `s_aura_wheel`, `s_beak_blast`, `s_beat_up`, `s_bide`, `s_core_enforcer`, `s_double_iron_bash`, `s_dragon_darts`, `s_flying_press`, `s_frustration`, `s_future_sight`, `s_hidden_power`, `s_ice_ball`, `s_ingrain`, `s_jungle_healing`, `s_leech_seed`, `s_life_dew`, `s_ohko`, `s_order_up`, `s_pain_split`, `s_payday`, `s_pre_attack_base`, `s_purify`, `s_return`, `s_rollout`, `s_roost`, `s_scale_shot`, `s_shell_trap`, `s_sparkly_swirl`, `s_split_up`, `s_trump_card`, `s_upper_hand` |
