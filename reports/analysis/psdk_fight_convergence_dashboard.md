...
Generated: 2026-05-20T22:39:24.985569Z

## Final Gate Axes

| Axis | Complete | Percent | Remaining |
| --- | ---: | ---: | ---: |
| Attacks | 381 / 728 | 52.3% | 347 |
| Methods | 197 / 330 | 59.7% | 133 |
| Effects | 368 / 482 | 76.3% | 114 |

## Effects By Family

| Family | Ported | Partial | Missing | Remaining |
| --- | ---: | ---: | ---: | ---: |
| ability | 195 | 17 | 42 | 59 |
| field | 15 | 0 | 0 | 0 |
| item | 64 | 6 | 17 | 23 |
| mechanics | 4 | 0 | 0 | 0 |
| move | 83 | 8 | 24 | 32 |
...
| --- | ---: | --- |
| Damage formula / variable power | 33 | `s_aqua_ring`, `s_aura_wheel`, `s_beak_blast`, `s_beat_up`, `s_bide`, `s_core_enforcer`, `s_double_iron_bash`, `s_dragon_darts`, `s_floral_healing`, `s_flying_press`, `s_frustration`, `s_future_sight`, `s_hidden_power`, `s_ice_ball`, `s_ingrain`, `s_jungle_healing`, `s_leech_seed`, `s_life_dew`, `s_ohko`, `s_order_up`, `s_pain_split`, `s_payday`, `s_pre_attack_base`, `s_purify`, `s_return`, `s_rollout`, `s_roost`, `s_scale_shot`, `s_shell_trap`, `s_sparkly_swirl`, `s_split_up`, `s_trump_card`, `s_upper_hand` |
...
Next recommended lot: close effect family `ability` (59 remaining effects).
