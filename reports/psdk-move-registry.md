...
| `s_aura_wheel` | `AuraWheel` | `10 Move/2 Definitions/300 AuraWheel.rb` | `TypeBasedMoveBehavior.auraWheel` | `ported` | `-` |
| `s_autotomize` | `Autotomize` | `10 Move/2 Definitions/300 Autotomize.rb` | `StaticBasicMoveRegistry.partialTargetMarker(s_autotomize)` | `ported` | `effects` |
...
| `s_chilly_reception` | `ChillyReception` | `10 Move/2 Definitions/300 ChillyReception.rb` | `StaticBasicMoveRegistry.s_chilly_reception` | `ported` | `-` |
...
| `s_core_enforcer` | `CoreEnforcer` | `10 Move/2 Definitions/300 CoreEnforcer.rb` | `StaticBasicMoveRegistry.s_core_enforcer` | `ported` | `-` |
| `s_corrosive_gas` | `CorrosiveGas` | `10 Move/2 Definitions/300 CorrosiveGas.rb` | `StaticBasicMoveRegistry.partialTargetMarker(s_corrosive_gas)` | `ported` | `effects` |
| `s_counter` | `Counter` | `10 Move/2 Definitions/300 Counter moves.rb` | `CounterDamageMoveBehavior.counter` | `ported` | `-` |
| `s_court_change` | `CourtChange` | `10 Move/2 Definitions/300 CourtChange.rb` | `StaticBasicMoveRegistry.s_court_change` | `ported` | `-` |
...
| `s_electrify` | `Electrify` | `10 Move/2 Definitions/300 Electrify.rb` | `StaticBasicMoveRegistry.partialTargetMarker(s_electrify)` | `ported` | `effects`, `action_order` |
...
| `s_flying_press` | `FlyingPress` | `10 Move/2 Definitions/300 FlyingPress.rb` | `StaticBasicMoveRegistry.partialBasic(s_flying_press)` | `ported` | `handler_damage`, `effects`, `ability`, `item` |
...
| `s_frustration` | `Frustration` | `10 Move/2 Definitions/300 Frustration.rb` | `VariablePowerMoveBehavior.frustration` | `ported` | `-` |
...
| `s_geomancy` | `Geomancy` | `10 Move/2 Definitions/300 Geomancy.rb` | `StaticBasicMoveRegistry.s_geomancy` | `ported` | `-` |
...
| `s_hidden_power` | `HiddenPower` | `10 Move/2 Definitions/300 HiddenPower.rb` | `TypeBasedMoveBehavior.hiddenPower` | `ported` | `-` |
...
| `s_order_up` | `OrderUp` | `10 Move/2 Definitions/300 OrderUp.rb` | `StaticBasicMoveRegistry.s_order_up` | `ported` | `-` |
...
| `s_payday` | `PayDay` | `10 Move/2 Definitions/300 Payday.rb` | `StaticBasicMoveRegistry.s_payday` | `ported` | `-` |
...
| `s_split_up` | `SpitUp` | `10 Move/2 Definitions/300 SpitUp.rb` | `StaticBasicMoveRegistry.s_split_up` | `ported` | `-` |
...
| `s_swallow` | `Swallow` | `10 Move/2 Definitions/300 Swallow.rb` | `StaticBasicMoveRegistry.s_swallow` | `ported` | `-` |
...
| `s_teleport` | `Teleport` | `10 Move/2 Definitions/300 Teleport.rb` | `StaticBasicMoveRegistry.s_teleport` | `ported` | `-` |
...
| `s_torment` | `Torment` | `10 Move/2 Definitions/300 Torment.rb` | `StaticBasicMoveRegistry.partialTargetMarker(s_torment)` | `ported` | `effects`, `history` |
...
| `s_upper_hand` | `UpperHand` | `10 Move/2 Definitions/300 UpperHand.rb` | `ActionGatedMoveBehavior.upperHand` | `ported` | `-` |
...
| `s_water_shuriken` | `WaterShuriken` | `10 Move/1 Mechanics/103 TwoHit MultiHit.rb` | `MultiHitMoveBehavior.waterShuriken` | `ported` | `-` |
