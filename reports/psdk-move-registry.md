...
| `s_after_you` | `AfterYou` | `10 Move/2 Definitions/300 After you.rb` | `StaticBasicMoveRegistry.partialTargetMarker(s_after_you)` | `partial` | `action_order` |
...
| `s_assist` | `Assist` | `10 Move/2 Definitions/300 Assist.rb` | `CopyCallMoveBehavior.assist` | `partial` | `history`, `action_order`, `effects` |
| `s_assurance` | `Assurance` | `10 Move/2 Definitions/300 Assurance.rb` | `HistoryPowerMoveBehavior.assurance` | `partial` | `effects` |
...
| `s_autotomize` | `Autotomize` | `10 Move/2 Definitions/300 Autotomize.rb` | `StaticBasicMoveRegistry.partialTargetMarker(s_autotomize)` | `partial` | `effects` |
| `s_avalanche` | `Avalanche` | `10 Move/2 Definitions/300 Avalanche.rb` | `HistoryPowerMoveBehavior.avalanche` | `partial` | `effects` |
| `s_baddy_bad` | `BaddyBad` | `10 Move/2 Definitions/300 GlitzyGlow.rb` | `StaticBasicMoveRegistry.s_baddy_bad` | `partial` | `effects` |
...
| `s_bestow` | `Bestow` | `10 Move/2 Definitions/300 Bestow.rb` | `ItemDependentMoveBehavior.bestow` | `partial` | `item`, `ability`, `effects` |
| `s_bide` | `Bide` | `10 Move/2 Definitions/300 Bide.rb` | `CounterDamageMoveBehavior.bide` | `partial` | `handler_damage`, `history`, `effects` |
...
| `s_camouflage` | `Camouflage` | `10 Move/2 Definitions/300 Camouflage.rb` | `FieldLocationMoveBehavior.camouflage` | `partial` | `field`, `effects` |
| `s_cantflee` | `CantSwitch` | `10 Move/2 Definitions/300 CantSwitch.rb` | `StaticBasicMoveRegistry.s_cantflee` | `ported` | `-` |
| `s_captivate` | `Captivate` | `10 Move/2 Definitions/300 Captivate.rb` | `StaticBasicMoveRegistry.secondaryOnly(s_captivate)` | `partial` | `effects`, `handler_status`, `handler_stat`, `ability` |
...
| `s_change_type` | `ChangeType` | `10 Move/2 Definitions/300 ChangeType.rb` | `StaticBasicMoveRegistry.s_change_type` | `partial` | `effects` |
...
| `s_corrosive_gas` | `CorrosiveGas` | `10 Move/2 Definitions/300 CorrosiveGas.rb` | `StaticBasicMoveRegistry.partialTargetMarker(s_corrosive_gas)` | `partial` | `effects` |
| `s_counter` | `Counter` | `10 Move/2 Definitions/300 Counter moves.rb` | `CounterDamageMoveBehavior.counter` | `partial` | `handler_damage`, `history`, `effects` |
...
| `s_disable` | `Disable` | `10 Move/2 Definitions/300 Disable.rb` | `StaticBasicMoveRegistry.disable` | `partial` | `effects` |
...
| `s_double_iron_bash` | `DoubleIronBash` | `10 Move/2 Definitions/300 DoubleIronBash.rb` | `MultiHitMoveBehavior.doubleIronBash` | `partial` | `targeting_multi`, `history`, `accuracy`, `ability`, `item` |
...
| `s_echo` | `EchoedVoice` | `10 Move/2 Definitions/300 EchoedVoice.rb` | `ConsecutivePowerMoveBehavior.echoedVoice` | `partial` | `effects` |
...
| `s_encore` | `Encore` | `10 Move/2 Definitions/300 Encore.rb` | `StaticBasicMoveRegistry.encore` | `partial` | `effects` |
...
| `s_fairy_lock` | `FairyLock` | `10 Move/2 Definitions/300 FairyLock.rb` | `StaticBasicMoveRegistry.partialFieldMarker(s_fairy_lock)` | `partial` | `field`, `effects` |
...
| `s_fell_stinger` | `FellStinger` | `10 Move/2 Definitions/300 FellStinger.rb` | `StaticBasicMoveRegistry.s_fell_stinger` | `partial` | `effects` |
| `s_fickle_beam` | `FickleBeam` | `10 Move/2 Definitions/300 FickleBeam.rb` | `StaticBasicMoveRegistry.s_fickle_beam` | `partial` | `effects` |
...
| `s_flame_burst` | `FlameBurst` | `10 Move/2 Definitions/300 FlameBurst.rb` | `StaticBasicMoveRegistry.s_flame_burst` | `partial` | `effects` |
| `s_fling` | `Fling` | `10 Move/2 Definitions/300 Fling.rb` | `ItemDependentMoveBehavior.fling` | `partial` | `item`, `ability`, `effects` |
...
| `s_fury_cutter` | `FuryCutter` | `10 Move/2 Definitions/300 FuryCutter.rb` | `ConsecutivePowerMoveBehavior.furyCutter` | `partial` | `effects` |
| `s_fusion_bolt` | `FusionBolt` | `10 Move/2 Definitions/300 FusionFlareBolt.rb` | `StaticBasicMoveRegistry.s_fusion_bolt` | `partial` | `effects` |
| `s_fusion_flare` | `FusionFlare` | `10 Move/2 Definitions/300 FusionFlareBolt.rb` | `StaticBasicMoveRegistry.s_fusion_flare` | `partial` | `effects` |
| `s_future_sight` | `FutureSight` | `10 Move/2 Definitions/300 FutureSight.rb` | `StaticBasicMoveRegistry.delayedMove(s_future_sight)` | `partial` | `effects`, `end_turn`, `handler_damage`, `handler_switch` |
...
| `s_genies_storm` | `GeniesStorm` | `10 Move/2 Definitions/300 GeniesStorm.rb` | `WeatherPowerMoveBehavior.geniesStorm` | `partial` | `effects` |
...
| `s_glitzy_glow` | `GlitzyGlow` | `10 Move/2 Definitions/300 GlitzyGlow.rb` | `StaticBasicMoveRegistry.s_glitzy_glow` | `partial` | `effects` |
...
| `s_grav_apple` | `GravApple` | `10 Move/2 Definitions/300 GravApple.rb` | `StaticBasicMoveRegistry.s_grav_apple` | `partial` | `effects` |
...
| `s_heal_block` | `HealBlock` | `10 Move/2 Definitions/300 HealBlock.rb` | `StaticBasicMoveRegistry.healBlock` | `partial` | `effects` |
...
| `s_ice_spinner` | `IceSpinner` | `10 Move/2 Definitions/300 IceSpinner SteelRoller.rb` | `StaticBasicMoveRegistry.s_ice_spinner` | `partial` | `effects` |
...
| `s_instruct` | `Instruct` | `10 Move/2 Definitions/300 Instruct.rb` | `CopyCallMoveBehavior.instruct` | `partial` | `history`, `action_order`, `effects` |
...
| `s_jump_kick` | `HighJumpKick` | `10 Move/2 Definitions/300 HighJumpKick.rb` | `StaticBasicMoveRegistry.s_jump_kick` | `partial` | `effects` |
...
| `s_knock_off` | `KnockOff` | `10 Move/2 Definitions/300 KnockOff.rb` | `ItemDependentMoveBehavior.knockOff` | `partial` | `item`, `ability`, `effects` |
| `s_laser_focus` | `LaserFocus` | `10 Move/2 Definitions/300 LaserFocus.rb` | `StaticBasicMoveRegistry.s_laser_focus` | `ported` | `effects` |
| `s_lash_out` | `LashOut` | `10 Move/2 Definitions/300 LashOut.rb` | `HistoryPowerMoveBehavior.lashOut` | `partial` | `effects` |
| `s_last_resort` | `LastResort` | `10 Move/2 Definitions/300 LastResort.rb` | `StaticBasicMoveRegistry.s_last_resort` | `ported` | `-` |
| `s_last_respects` | `LastRespects` | `10 Move/2 Definitions/300 LastRespects.rb` | `StaticBasicMoveRegistry.s_last_respects` | `partial` | `effects` |
...
| `s_magnitude` | `Magnitude` | `10 Move/2 Definitions/300 Magnitude.rb` | `StaticBasicMoveRegistry.s_magnitude` | `partial` | `effects` |
| `s_make_it_rain` | `MakeItRain` | `10 Move/2 Definitions/300 MakeItRain.rb` | `StaticBasicMoveRegistry.s_make_it_rain` | `partial` | `effects` |
| `s_me_first` | `MeFirst` | `10 Move/2 Definitions/300 Me First.rb` | `CopyCallMoveBehavior.meFirst` | `partial` | `history`, `action_order`, `effects` |
| `s_memento` | `Memento` | `10 Move/2 Definitions/300 Memento.rb` | `StaticBasicMoveRegistry.s_memento` | `ported` | `-` |
| `s_metal_burst` | `MetalBurst` | `10 Move/2 Definitions/300 Counter moves.rb` | `CounterDamageMoveBehavior.metalBurst` | `partial` | `handler_damage`, `history`, `effects` |
| `s_metronome` | `Metronome` | `10 Move/2 Definitions/300 Metronome.rb` | `CopyCallMoveBehavior.metronome` | `partial` | `history`, `action_order`, `effects` |
| `s_mimic` | `Mimic` | `10 Move/2 Definitions/300 Mimic.rb` | `CopyCallMoveBehavior.mimic` | `partial` | `history`, `action_order`, `effects` |
| `s_mind_blown` | `MindBlown` | `10 Move/2 Definitions/300 MindBlown.rb` | `MindBlownMoveBehavior.mindBlown` | `ported` | `-` |
| `s_mind_reader` | `LockOn` | `10 Move/2 Definitions/300 LockOn.rb` | `StaticBasicMoveRegistry.s_mind_reader` | `partial` | `effects` |
...
| `s_mirror_coat` | `MirrorCoat` | `10 Move/2 Definitions/300 Counter moves.rb` | `CounterDamageMoveBehavior.mirrorCoat` | `partial` | `handler_damage`, `history`, `effects` |
| `s_mirror_move` | `MirrorMove` | `10 Move/2 Definitions/300 MirrorMove.rb` | `CopyCallMoveBehavior.mirrorMove` | `partial` | `history`, `action_order`, `effects` |
...
| `s_nature_power` | `NaturePower` | `10 Move/2 Definitions/300 NaturePower.rb` | `FieldLocationMoveBehavior.naturePower` | `partial` | `field`, `effects` |
...
| `s_octolock` | `Octolock` | `10 Move/2 Definitions/300 Octolock.rb` | `StaticBasicMoveRegistry.partialTargetMarker(s_octolock)` | `partial` | `effects` |
...
| `s_parting_shot` | `PartingShot` | `10 Move/2 Definitions/300 PartingShot.rb` | `StaticBasicMoveRegistry.secondaryOnly(s_parting_shot)` | `partial` | `effects`, `handler_status`, `handler_stat`, `ability` |
| `s_payback` | `PayBack` | `10 Move/2 Definitions/300 PayBack.rb` | `HistoryPowerMoveBehavior.payback` | `partial` | `effects` |
...
| `s_plasma_fists` | `PlasmaFists` | `10 Move/2 Definitions/300 PlasmaFists.rb` | `StaticBasicMoveRegistry.s_plasma_fists` | `partial` | `effects` |
...
| `s_pursuit` | `Pursuit` | `10 Move/2 Definitions/300 Pursuit.rb` | `StaticBasicMoveRegistry.s_pursuit` | `partial` | `effects` |
| `s_quash` | `Quash` | `10 Move/2 Definitions/300 Quash.rb` | `StaticBasicMoveRegistry.partialTargetMarker(s_quash)` | `partial` | `action_order` |
| `s_rage` | `Rage` | `10 Move/2 Definitions/300 Rage.rb` | `StaticBasicMoveRegistry.s_rage` | `partial` | `effects` |
| `s_rage_fist` | `RageFist` | `10 Move/2 Definitions/300 RageFist.rb` | `HistoryPowerMoveBehavior.rageFist` | `partial` | `effects` |
| `s_raging_bull` | `RagingBull` | `10 Move/2 Definitions/300 BrickBreak.rb` | `StaticBasicMoveRegistry.s_raging_bull` | `partial` | `effects` |
...
| `s_round` | `Round` | `10 Move/2 Definitions/300 Round.rb` | `ConsecutivePowerMoveBehavior.round` | `partial` | `action_order`, `history`, `targeting_multi` |
...
| `s_sappy_seed` | `SappySeed` | `10 Move/2 Definitions/300 SappySeed.rb` | `StaticBasicMoveRegistry.s_sappy_seed` | `partial` | `effects` |
| `s_scale_shot` | `ScaleShot` | `10 Move/2 Definitions/300 ScaleShot.rb` | `MultiHitMoveBehavior.scaleShot` | `partial` | `targeting_multi`, `history`, `accuracy`, `ability`, `item` |
...
| `s_shell_side_arm` | `ShellSideArm` | `10 Move/2 Definitions/300 ShellSideArm.rb` | `StaticBasicMoveRegistry.s_shell_side_arm` | `partial` | `effects` |
...
| `s_sketch` | `Sketch` | `10 Move/2 Definitions/300 Sketch.rb` | `CopyCallMoveBehavior.sketch` | `partial` | `history`, `action_order`, `effects` |
...
| `s_sleep_talk` | `SleepTalk` | `10 Move/2 Definitions/300 SleepTalk.rb` | `CopyCallMoveBehavior.sleepTalk` | `partial` | `history`, `action_order`, `effects` |
...
| `s_spectral_thief` | `SpectralThief` | `10 Move/2 Definitions/300 SpectralThief.rb` | `StaticBasicMoveRegistry.s_spectral_thief` | `partial` | `effects` |
...
| `s_steel_roller` | `SteelRoller` | `10 Move/2 Definitions/300 IceSpinner SteelRoller.rb` | `StaticBasicMoveRegistry.s_steel_roller` | `partial` | `effects` |
...
| `s_stockpile` | `Stockpile` | `10 Move/2 Definitions/300 Stockpile.rb` | `StaticBasicMoveRegistry.s_stockpile` | `partial` | `effects` |
| `s_stomp` | `Stomp` | `10 Move/2 Definitions/300 Stomp.rb` | `StaticBasicMoveRegistry.s_stomp` | `partial` | `effects` |
...
| `s_struggle` | `Struggle` | `10 Move/2 Definitions/300 RecoilMove.rb` | `RecoilMoveBehavior.struggle` | `partial` | `effects` |
...
| `s_super_duper_effective` | `SuperDuperEffective` | `10 Move/2 Definitions/300 SuperDuperEffective.rb` | `StaticBasicMoveRegistry.s_super_duper_effective` | `partial` | `effects` |
...
| `s_toxic_thread` | `ToxicThread` | `10 Move/2 Definitions/300 ToxicThread.rb` | `StaticBasicMoveRegistry.secondaryOnly(s_toxic_thread)` | `partial` | `effects`, `handler_status`, `handler_stat`, `ability` |
...
| `s_venom_drench` | `VenomDrench` | `10 Move/2 Definitions/300 VenomDrench.rb` | `StaticBasicMoveRegistry.secondaryOnly(s_venom_drench)` | `partial` | `effects`, `handler_status`, `handler_stat`, `ability` |
