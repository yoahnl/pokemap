...
| `s_conversion2` | `Conversion2` | `10 Move/2 Definitions/300 Conversion.rb` | `StaticBasicMoveRegistry.s_conversion2` | `ported` | `-` |
...
| `s_destiny_bond` | `DestinyBond` | `10 Move/2 Definitions/300 DestinyBond.rb` | `StaticBasicMoveRegistry.s_destiny_bond` | `ported` | `-` |
...
| `s_embargo` | `Embargo` | `10 Move/2 Definitions/300 Embargo.rb` | `StaticBasicMoveRegistry.targetMarker(s_embargo)` | `ported` | `-` |
...
| `s_entrainment` | `Entrainment` | `10 Move/2 Definitions/300 AbilityChanging.rb` | `StaticBasicMoveRegistry.abilityChanging(s_entrainment)` | `ported` | `-` |
...
| `s_flower_shield` | `FlowerShield` | `10 Move/2 Definitions/300 FlowerShield.rb` | `StaticBasicMoveRegistry.resolveSupportStatMove(s_flower_shield)` | `ported` | `-` |
...
| `s_gear_up` | `GearUp` | `10 Move/2 Definitions/300 GearUp.rb` | `StaticBasicMoveRegistry.resolveSupportStatMove(s_gear_up)` | `ported` | `-` |
...
| `s_gravity` | `Gravity` | `10 Move/2 Definitions/300 Gravity.rb` | `StaticBasicMoveRegistry.s_gravity` | `ported` | `-` |
...
| `s_grudge` | `Grudge` | `10 Move/2 Definitions/300 Grudge.rb` | `StaticBasicMoveRegistry.s_grudge` | `ported` | `-` |
...
| `s_happy_hour` | `HappyHour` | `10 Move/2 Definitions/300 HappyHour.rb` | `StaticBasicMoveRegistry.fieldMarker(s_happy_hour)` | `ported` | `-` |
...
| `s_healing_wish` | `HealingWish` | `10 Move/2 Definitions/300 HealingSacrifice.rb` | `StaticBasicMoveRegistry.s_healing_wish` | `ported` | `-` |
...
| `s_ion_deluge` | `IonDeluge` | `10 Move/2 Definitions/300 Ion Deluge.rb` | `StaticBasicMoveRegistry.fieldMarker(s_ion_deluge)` | `ported` | `effects`, `field` |
...
| `s_magnetic_flux` | `MagneticFlux` | `10 Move/2 Definitions/300 MagneticFlux.rb` | `StaticBasicMoveRegistry.resolveSupportStatMove(s_magnetic_flux)` | `ported` | `-` |
...
| `s_nightmare` | `Nightmare` | `10 Move/2 Definitions/300 Nightmare.rb` | `StaticBasicMoveRegistry.targetMarker(s_nightmare)` | `ported` | `-` |
| `s_no_retreat` | `NoRetreat` | `10 Move/2 Definitions/300 NoRetreat.rb` | `StaticBasicMoveRegistry.s_no_retreat` | `ported` | `-` |
...
| `s_perish_song` | `PerishSong` | `10 Move/2 Definitions/300 PerishSong.rb` | `StaticBasicMoveRegistry.targetMarker(s_perish_song)` | `ported` | `-` |
...
| `s_powder` | `Powder` | `10 Move/2 Definitions/300 Powder.rb` | `StaticBasicMoveRegistry.targetMarker(s_powder)` | `ported` | `-` |
...
| `s_rototiller` | `Rototiller` | `10 Move/2 Definitions/300 Rototiller.rb` | `StaticBasicMoveRegistry.resolveSupportStatMove(s_rototiller)` | `ported` | `-` |
...
| `s_spite` | `Spite` | `10 Move/2 Definitions/300 Spite.rb` | `StaticBasicMoveRegistry.s_spite` | `ported` | `-` |
...
| `s_stuff_cheeks` | `StuffCheeks` | `10 Move/2 Definitions/300 StuffCheeks.rb` | `StaticBasicMoveRegistry.s_stuff_cheeks` | `ported` | `-` |
...
| `s_teatime` | `Teatime` | `10 Move/2 Definitions/300 TeaTime.rb` | `StaticBasicMoveRegistry.s_teatime` | `ported` | `-` |
