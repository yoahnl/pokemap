...
| `s_2turns` | `TwoTurnBase` | `10 Move/1 Mechanics/110 TwoTurnBase.rb` | `StaticBasicMoveRegistry.s_2turns` | `partial` | `effects`, `action_order`, `weather`, `item`, `targeting_multi` |
...
| `s_bind` | `Bind` | `10 Move/2 Definitions/300 Bind.rb` | `StaticBasicMoveRegistry.s_bind` | `partial` | `effects`, `item`, `handler_switch` |
...
| `s_cantflee` | `CantSwitch` | `10 Move/2 Definitions/300 CantSwitch.rb` | `StaticBasicMoveRegistry.s_cantflee` | `partial` | `effects`, `handler_switch` |
| `s_captivate` | `Captivate` | `10 Move/2 Definitions/300 Captivate.rb` | `StaticBasicMoveRegistry.secondaryOnly(s_captivate)` | `partial` | `-` |
| `s_ceaseless_edge` | `CeaselessEdge` | `10 Move/2 Definitions/300 HazardsSetting.rb` | `StaticBasicMoveRegistry.s_ceaseless_edge` | `partial` | `-` |
...
| `s_defog` | `Defog` | `10 Move/2 Definitions/300 Defog.rb` | `StaticBasicMoveRegistry.s_defog` | `partial` | `-` |
...
| `s_flame_burst` | `FlameBurst` | `10 Move/2 Definitions/300 FlameBurst.rb` | `StaticBasicMoveRegistry.partialBasic(s_flame_burst)` | `partial` | `-` |
...
| `s_fusion_bolt` | `FusionBolt` | `10 Move/2 Definitions/300 FusionFlareBolt.rb` | `StaticBasicMoveRegistry.partialBasic(s_fusion_bolt)` | `partial` | `-` |
| `s_fusion_flare` | `FusionFlare` | `10 Move/2 Definitions/300 FusionFlareBolt.rb` | `StaticBasicMoveRegistry.partialBasic(s_fusion_flare)` | `partial` | `-` |
...
| `s_mimic` | `Mimic` | `10 Move/2 Definitions/300 Mimic.rb` | `StaticBasicMoveRegistry.partialTargetMarker(s_mimic)` | `partial` | `-` |
...
| `s_photon_geyser` | `PhotonGeyser` | `10 Move/2 Definitions/300 PhotonGeyser.rb` | `StaticBasicMoveRegistry.partialBasic(s_photon_geyser)` | `partial` | `-` |
...
| `s_reload` | `Reload` | `10 Move/2 Definitions/300 Reload.rb` | `StaticBasicMoveRegistry.s_reload` | `partial` | `effects`, `history`, `action_order` |
...
| `s_tidy_up` | `TidyUp` | `10 Move/2 Definitions/300 TidyUp.rb` | `StaticBasicMoveRegistry.partialUserBankMarker(s_tidy_up)` | `partial` | `-` |
...
| `s_toxic_spike` | `ToxicSpikes` | `10 Move/2 Definitions/300 Toxic_Spikes.rb` | `StaticBasicMoveRegistry.partialFoeBankMarker(s_toxic_spike)` | `partial` | `effects`, `handler_switch`, `grounded` |
